    ...
    describe('Orders controllers', function () {
        ...
        describe('OrdersCtrl', function () {
            ...
            it('should call POST xhr on create and on success add to the orders by 1', function () {
                ...
                expect(resource.post).wasCalledWith(scope.collection, 'self', 'application/json', itemAttrs);
            ...
            it('should call PUT on update and success set item back to viewing', function () {
                ...
                var order = {links: itemLinks, viewstate: {viewing: false, updating: true}};
                scope.order = order;
            ...
            it('should call DELETE xhr on remove and failed', function () {
                ...
                expect(resource.del).wasCalledWith(order, 'self', 'application/json');
            ...
            describe('ViewState', function () {
                ...
                it('edit - attrs as string', function () {
                    ...
                    put.resolve();
                    scope.$root.$digest();
                    expect(resource.put).wasCalledWith(viewstate, 'self', 'application/json', { viewing: false });
                ...
                it('cancel - attrs as array', function () {
                    ...
                    put.resolve();
                    scope.$root.$digest();
                    expect(resource.put).wasCalledWith(viewstate, 'self', 'application/json', { viewing: false, updating: true });
                    expect(location.set).wasCalledWith(viewstate, 'self');
                });
            });
