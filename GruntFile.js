...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    protractor: {
      e2e: {
        configFile: "configs/e2e.protractor.conf.js",
        keepAlive: true,
        options: {
          args: {
            baseUrl: 'http://0.0.0.0:8333'
          }
        }
      }
    }
  ...
  grunt.registerTask('acceptance', ['simplemocha:acceptance', /*'exec:test',*/ 'protractor']);  // TODO: spin up test
